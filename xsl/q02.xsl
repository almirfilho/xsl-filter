...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="brasil">
		...
		<div class="page-header">
			<h1><span class="small">Questão 02:</span> <span id="title">Nome, capital, área e população dos Estados da Região Nordeste</span></h1>
		</div>
		<table class="table table-striped table-bordered">
			...
			<tbody>
			<xsl:apply-templates select="estado[regiao='NE']">
